# =========================================================================
#   THE MACHINE LEARNING MODEL FUNCTIONS (Re-defined for production)
# =========================================================================

def get_similar_products_cosine_similarity(product_id, top_n=10):
...
def recommend_user_via_basket_items_prod_name(user_id, top_n=5):
...
def recommend_user_via_users_prod_name(user_id, top_n=5, n_similar_users=10):
...
def get_similar_products_knn_full(product_id, top_n=10):
...
def recommend_grocery_meta(parent_asin):
